...
fair; the gap is database-depth limited on this laptop, not algorithmic.
...
numeric NISQ pipeline trails the paper (160.9 vs 107) for database-depth
reasons. Four levers are implemented and opt-in from
