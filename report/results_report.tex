...
exact-verified against the snapped input's unitary) --- more than $2\times$
shorter than the numeric protocol's best of 226--228, and comparable to the
$\sim$24\% ratio the exact engine reaches on the unrelated Table 6
random-circuit protocol ($73.5/300$). Figures~\ref{fig:motivation} and \ref{fig:pipeline} show the
