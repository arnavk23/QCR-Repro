...
def main() -> None:
    strict_dir = Path("results/demo_sweep/strict")
    loose_dir = Path("results/demo_sweep/loose")
    ...
    out_csv = out_root / "protocol_report_table.csv"
    ...
    out_md = out_root / "protocol_report.md"
