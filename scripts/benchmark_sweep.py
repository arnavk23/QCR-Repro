...
from qcr_repro.qasm_io import parse_qasm_subset, write_qasm_subset
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="results/paper_protocol_1e-5", help="Directory for CSV and optional reduced outputs")
