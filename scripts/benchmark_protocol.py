...
Usage:
    python scripts/benchmark_protocol.py --gateset ion_trap --num-circuits 100
    python scripts/benchmark_protocol.py --gateset nisq --num-circuits 100 \\
...
def main() -> None:
    ...
    parser.add_argument("--outdir", type=str, default="results/protocol_stats")
