...
Usage:
    python scripts/bench_exact.py --gateset ion_trap --num-qubits 3 \
        --num-circuits 16 --length 300 --budget 10 --outdir results_exact
    python scripts/bench_exact.py --gateset nisq_clifford --num-qubits 3 \
        --num-circuits 16 --length 300 --budget 10 --outdir results_exact
"""
...
def main() -> None:
    ...
    parser.add_argument("--outdir", type=str, default="results_exact")
